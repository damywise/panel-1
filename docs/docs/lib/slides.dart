...
<section data-title="Pop out">
  ...
  child: <span class="t">RegularWindow</span>(                   <span class="c">// the main window</span>
    controller: <span class="t">RegularWindowController</span>(),
    child: <span class="t">AppShell</span>(home: <span class="t">PanelDock</span>()),
  ),
));
<span class="c">// detach → register another RegularWindow as a new view</span></pre>
</section>
